        ...
        >
          <div className="bg-gradient-to-r from-blob-yellow/10 to-yellow-500/10 rounded-2xl p-8 border border-blob-yellow/20">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Join the NarrativeScope community and get access to comprehensive market intelligence. See patterns that individual traders miss in the chaos of Solana meme coin degeneracy.
            </p>
